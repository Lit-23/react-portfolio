    ...
    return (
        <nav className="top-0 z-20 w-full px-[24px] xl:px-0">
            <div className="flex flex-wrap items-center justify-between max-w-[1160px] w-full py-7 mx-auto">
                <div className="lg:text-[28px] text-2xl font-black text-neutral-300">Rommel.</div>
                <div className="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
                    <div className="flex justify-between items-center  gap-[13px] ">
                        <a href='https://github.com/Lit-23' className='z-30' target='_blank'> 
                            <div>
                        ...
                        <a href='https://www.linkedin.com/in/rommel-marquez-8754b4263/' className='z-30' target='_blank'> 
                            <div>
