    ...
    <section id="home" className="scroll-pt-32 max-w-[1160px] w-full mx-auto mt-[45px] lg:mt-[70px]  px-[24px] xl:px-0">
        <div className="flex lg:flex-row flex-col-reverse items-center justify-between gap-9">
            <div data-aos="fade-down-left" data-aos-duration="1000" className="max-w-[694px] w-full flex flex-col gap-4 lg:gap-[32px] ">
                ...
                <div className="w-full lg:max-w-[79%]">
                    <p className="text-white lg:text-start md:text-center leading-[1.5]">
                        Hello there! I'm Rommel Marquez, a junior<span className="font-bold"> Full-Stack Developer</span> with a passion
                        ...
                        ,<span className="font-bold"> NodeJs</span>, and more.
                    </p>
                ...
                <div className='flex gap-3'>
                    ...
                    <a href="https://drive.google.com/file/d/1F32xdI1ru_fHWvgxtLN5QFJqw4sJnnLm/view?usp=sharing" target='_blank' className="flex text-blue-500 font-bold hover:shadow-2xl lg:mx-0 md:mx-auto duration-300 hover:shadow-blue-500/50 w-[179px] border-solid border-2 border-blue-500 rounded-lg items-center gap-3 justify-center py-2 ">
            ...
            <div data-aos="fade-up-left" data-aos-duration="1000" className="hidden lg:block w-full lg:w-[397px] relative">
                <img className="rounded-lg ml-auto w-full lg:h-[483px] object-cover" src={heroImage} alt="avatar"/>
            </div>
        </div>
    </section>
    </>
