        ...
        <div className="flex lg:flex-row flex-col-reverse items-center justify-between gap-9">
            <div data-aos="fade-down-left" data-aos-duration="1000" className="max-w-[694px] w-full flex flex-col gap-4 lg:gap-[32px] ">
                ...
                <div className='flex gap-3'>
                    ...
                    <a href="" className="flex text-blue-500 font-bold hover:shadow-2xl lg:mx-0 md:mx-auto duration-300 hover:shadow-blue-500/50 w-[179px] border-solid border-2 border-blue-500 rounded-lg items-center gap-3 justify-center py-2 ">
